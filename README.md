...
Complete usage (--help output): 

Sea ice training v2 [-h] [--data DATA] [--sensors SENSORS [SENSORS ...]] [--output OUTPUT] [--tag TAG] [--modeltag MODELTAG] [--batchsize BATCHSIZE] [--stepstart STEPSTART] [--nsteps NSTEPS]
                           [--nepochs NEPOCHS] [--diagsonly] [--trainonly] [--reproducible]
