...
#SBATCH --gpus=1
#SBATCH --job-name=seaice_gpu1epochs
#SBATCH -o /perm/dnk8355/paper2026/outputs_training/sbatchlogs/seaice_gpu_exp2_METOPBandC_1epochs.out
#SBATCH -e /perm/dnk8355/paper2026/outputs_training/sbatchlogs/seaice_gpu_exp2_METOPBandC_1epochs.err
...
python3 ${sourcePath}/${pyScript} \
  ...
  --output /perm/dnk8355/paper2026/outputs_training/exp2_METOPBandC \
  --tag 1april2024_31march2026_bg_emis07_with_losses_adjusted_obs_errors_bg_biasice0_ocean0_bg_bias_err1_7neurons_update_false_sic0_002_newimplementation_in_emisNN_with_angle_and_zenith_1epochs_sbatch_python3_10 \
  --nepochs 1 \
